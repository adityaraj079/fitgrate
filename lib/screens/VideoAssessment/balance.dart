        ...
        child: Column(
          children: [
              Padding(
                ...
                child: Text('Balance', style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
              ),
...
Expanded(
       ...
       Row(
         ...
         children: [
           Text('Parameter', style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
           Padding(
             padding: const EdgeInsets.fromLTRB(20, 0, 0, 0),
             child: Text('Time (secs)', style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
           ),
         ],
       ),
           ...
           Padding(
             ...
             child: Container(
               ...
               child: Padding(
                 ...
                 child: Text('Left Leg (eye open)', style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
               ),
             ),
           ),
