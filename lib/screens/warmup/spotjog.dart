      ...
      body: Column(
        children: [
          Center(child: Padding(
            ...
            child: Text("1/11", style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
           ),
          ),
          ...
          Row(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.all(10.0),
                child: Text('Spot Jogging', style: TextStyle(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),),
              ),
